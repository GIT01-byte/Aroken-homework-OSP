		...
		public function filter_map_data_for_saving( $new_value, $id, $real_key ) {
			...
			if ( empty( $new_value['address'] ) ) {
				...
				if ( empty( $google_maps_api_key ) ) {
					throw new Exception( wp_kses_post( __( 'You need to configure your Google Maps API key to save the Google Maps columns. This is required by Advanced Custom Fields, <a href="https://www.advancedcustomfields.com/blog/google-maps-api-settings/" target="_blank">you can follow this tutorial</a>', 'vg_sheet_editor' ) ) );
				}
