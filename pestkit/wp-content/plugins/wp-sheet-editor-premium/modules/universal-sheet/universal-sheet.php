	...
	class WP_Sheet_Editor_Universal_Sheet {
		...
		function get_import_sources_options() {
			$out = array(
				...
				'csv_upload'  => esc_html__( 'File from my computer', 'vg_sheet_editor' ),
				'csv_url'     => esc_html__( 'File from url', 'vg_sheet_editor' ),
				'paste'       => esc_html__( 'Copy/paste from another spreadsheet or table', 'vg_sheet_editor' ),
				'server_file' => esc_html__( 'File in the server', 'vg_sheet_editor' ),
			);
		...
		function get_allowed_file_formats() {
			$formats = array( 'csv', 'json', 'xlsx', 'xls', 'xml' );
