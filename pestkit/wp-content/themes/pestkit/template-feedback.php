...
<div class="comment-form-wrapper bg-light rounded p-5 mt-5">
    <div class="container">
        <h3 class="mb-4 text-dark fw-bold text-center">
        ...
        <form id="custom-ajax-feedback-form" novalidate>
            ...
            <div class="row g-3">
                <div class="col-md-6 position-relative">
                    <input type="text" name="author" class="form-control py-3" placeholder="<?php the_field('feedback_placeholder_name') ?>">
                    <div class="error-text-under" id="error-author"></div>
                </div>
                <div class="col-md-6 position-relative">
                    <input type="email" name="email" class="form-control py-3" placeholder="<?php the_field('feedback_placeholder_email') ?>">
                ...
                <div class="col-12 mb-2">
                    <div class="d-flex align-items-center">
                        <span class="text-dark fw-bold me-3">
                            <?php the_field('feedback_text_before_stars') ?>
                        </span>
                ...
                <div class="col-12 position-relative">
                    <textarea name="comment" class="form-control py-3" rows="5" placeholder="<?php the_field('feedback_placeholder_text') ?>"></textarea>
                </div>
                <div class="col-12 text-center">
                    <button type="submit" class="comment-submit-btn btn btn-primary border-0 rounded-pill py-3 px-5 text-uppercase w-100">
                        <?php the_field("feedback_btn_text") ?>
                    </button>
                </div>
            </div>
        </form>
